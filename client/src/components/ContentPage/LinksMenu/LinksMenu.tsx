...
const LinksMenu = ({callback} : IProps) => {
    ...
    const menuItems = useMemo(() => [
        {
            label: <Space>
                <HomeOutlined/>
                <Link onClick={callback} to={"/main"}>Main</Link>
            </Space>,
            key: 1
        },
        {
        ...
        },
        {
            label: <Space>
                <SnippetsOutlined/>
                <Link onClick={callback} to={"/notes"}>Notes</Link>
            </Space>,
            key: 3
        },
        {
            label: <Space>
                <UserOutlined/>
                <Link onClick={callback} to={"/share"}>Shared</Link>
            </Space>,
            key: 4
        },
